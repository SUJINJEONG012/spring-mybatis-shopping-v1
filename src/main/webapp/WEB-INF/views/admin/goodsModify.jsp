				...
				<div class="admin_content_main">
					<form action="/admin/goodsModify" method="post" id="modifyForm">
						...
						<div class="form_section">
							...
							<div class="form_section_content flex">
								<input id="authName_input" readonly="readonly"
									value="${goodsInfo.authName}"> <input
						...
						<div class="form_section">
							...
							<div class="form_section_content flex">
								<input name="publeYear" autocomplete="off" readonly="readonly"
									lang="en"> <span class="ck_warn publeYear_warn">출판일을
									선택해주세요.</span>
							</div>
						</div>
						<div class="form_section">
						...
						<div class="form_section">
							...
							<div class="form_section_content">
								<input name="bookPrice" value="${goodsInfo.bookPrice}" lang="en">
						...
						<div class="form_section">
							...
							<div class="form_section_content">
								<input name="bookStock" value="${goodsInfo.bookStock}" lang="en">
						...
						<div class="form_section">
							...
							<div class="form_section_content">
								...
								<input name="bookDiscount" type="hidden"
									value="${goodsInfo.bookDiscount}">
								<p class="step_val">
									할인 가격 : <strong class="span_discount" lang="en"></strong>
								</p>
