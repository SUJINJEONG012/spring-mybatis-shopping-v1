					...
					<div class="admin_content_main">
						<form id="modifyForm" action="/admin/authorModify" method="post">
							...
							<div class="form_section">
								...
								<div class="form_section_content">
									<textarea name="authorIntro">
					<c:out value='${authorInfo.authorIntro }' /></textarea>
									<span id="warn_authorIntro">작가소개를 해주세요.</span>
								</div>
							</div>
							<div class="form_section">
								<div class="form_section_title">
		...
		$("#deleteBtn")
				.on(
						...
						function(e) {
							...
							moveForm
									.append('<input type="hidden" name="authorId" value="${authorInfo.authorId}">');
		...
		$("#modifyBtn")
				.on(
						...
						function(e) {
							...
							let authName = $(
									".form_section_content input=[name='authName']")
									.val();
							let authorIntro = $(
									".form_section_context textarea").val();
							...
							if (!authName) {
								$("#warn_authName").css("display", "block");
							} else {
